...
import MobileDynamicSelectDropDown from "./MobileDynamicSelectDropDown";


const MobilePracticeLocation = () => {
...
export default MobilePracticeLocation
